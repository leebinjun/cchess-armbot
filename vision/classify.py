...
class Classify():
    ...
    def __init__(self, 
                 labels_path = r'./vision/tmp/output_labels.txt',
                 graph_path = r'./vision/tmp/output_graph.pb'):
        print("载入模型")
    ...
    def _get_lables(self, labels_path = r'./vision/tmp/output_labels.txt'):
    ...
    def _get_graph(self, graph_path = r'./vision/tmp/output_graph.pb'):

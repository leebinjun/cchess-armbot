...
class Chessboard(object):
    ...
    def init_board(self, init_state=None):
        if init_state is None:
            ...
            black_cannon_flag = 0
            red_elephant_flag = 0
            black_elephant_flag = 0
            red_mandarin_flag = 0
            black_mandarin_flag = 0
            red_pawn_flag = 0
            black_pawn_flag = 0
            red_rook_left = Rook(u" 车l红 ", "red_rook_left", True, self, 'R')
            red_rook_right = Rook(u" 车r红 ", "red_rook_right", True, self, 'R')
            ...
            mess_board_y = 9
            mess_board_x = 0
            for mess_chessman in mess_board :
                if(mess_chessman == '/') :
                    mess_board_y = mess_board_y-1
                    mess_board_x = 0
                elif(mess_chessman > '0' and mess_chessman <= '9') :
                    mess_board_x += ord(mess_chessman)-ord('0')
                elif(mess_chessman == 'R') :
                    if(red_rook_flag == 0) :
                        red_rook_left.add_to_board(mess_board_x,mess_board_y)
                    else :
                        red_rook_right.add_to_board(mess_board_x,mess_board_y)
                    red_rook_flag += 1
                    mess_board_x += 1
                elif(mess_chessman == 'r') :
                    if(black_rook_flag == 0) :
                        black_rook_left.add_to_board(mess_board_x,mess_board_y)
                    else :
                        black_rook_right.add_to_board(mess_board_x,mess_board_y)
                    black_rook_flag += 1
                    mess_board_x += 1
                elif(mess_chessman == 'K') :
                    if(red_rook_flag == 0) :
                        red_knight_left.add_to_board(mess_board_x,mess_board_y)
                    else :
                        red_knight_right.add_to_board(mess_board_x,mess_board_y)
                    red_knight_flag += 1
                    mess_board_x += 1
                elif(mess_chessman == 'k') :
                    
                    if(black_knight_flag == 0) :
                        black_knight_left.add_to_board(mess_board_x,mess_board_y)
                    else :
                        black_knight_right.add_to_board(mess_board_x,mess_board_y)
                    black_knight_flag += 1
                    mess_board_x += 1
                elif(mess_chessman == 'E') :
                    
                    if(red_elephant_flag == 0) :
                        red_elephant_left.add_to_board(mess_board_x,mess_board_y)
                    else :
                        red_elephant_right.add_to_board(mess_board_x,mess_board_y)
                    red_elephant_flag += 1
                    mess_board_x += 1
                elif(mess_chessman == 'e') :
                    
                    if(black_elephant_flag == 0) :
                        black_elephant_left.add_to_board(mess_board_x,mess_board_y)
                    else :
                        black_elephant_right.add_to_board(mess_board_x,mess_board_y)
                    black_elephant_flag += 1
                    mess_board_x += 1
                elif(mess_chessman == 'M') :
                    
                    if(red_mandarin_flag == 0) :
                        red_mandarin_left.add_to_board(mess_board_x,mess_board_y)
                    else :
                        red_mandarin_right.add_to_board(mess_board_x,mess_board_y)
                    red_mandarin_flag += 1
                    mess_board_x += 1
                elif(mess_chessman == 'm') :
                    
                    if(black_mandarin_flag == 0) :
                        black_mandarin_left.add_to_board(mess_board_x,mess_board_y)
                    else :
                        black_mandarin_right.add_to_board(mess_board_x,mess_board_y)
                    black_mandarin_flag += 1 
                    mess_board_x += 1
                elif(mess_chessman == 'C') :
                    if(red_cannon_flag == 0) :
                        red_cannon_left.add_to_board(mess_board_x,mess_board_y)
                    else :
                        red_cannon_right.add_to_board(mess_board_x,mess_board_y)
                    red_cannon_flag += 1
                    mess_board_x += 1
                elif(mess_chessman == 'c') :
                    if(black_cannon_flag == 0) :
                        black_cannon_left.add_to_board(mess_board_x,mess_board_y)
                    else :
                        black_cannon_right.add_to_board(mess_board_x,mess_board_y)
                    black_cannon_flag += 1 
                    mess_board_x += 1
                elif(mess_chessman == 'S') :
                    red_king.add_to_board(mess_board_x,mess_board_y)
                    mess_board_x += 1
                if(mess_chessman == 's') :
                    black_king.add_to_board(mess_board_x,mess_board_y) 
                    mess_board_x += 1
                elif(mess_chessman == 'P') :    
                    if(red_pawn_flag == 0) :
                        red_pawn_1.add_to_board(mess_board_x,mess_board_y)
                    elif(red_pawn_flag == 1):
                        red_pawn_2.add_to_board(mess_board_x,mess_board_y)
                    elif(red_pawn_flag == 2):
                        red_pawn_3.add_to_board(mess_board_x,mess_board_y)
                    elif(red_pawn_flag == 3):
                        red_pawn_4.add_to_board(mess_board_x,mess_board_y)
                    elif(red_pawn_flag == 4):
                        red_pawn_5.add_to_board(mess_board_x,mess_board_y)
                    red_pawn_flag += 1
                    mess_board_x += 1
                elif(mess_chessman == 'p') :    
                    if(black_pawn_flag == 0) :
                        black_pawn_1.add_to_board(mess_board_x,mess_board_y)
                    elif(black_pawn_flag == 1):
                        black_pawn_2.add_to_board(mess_board_x,mess_board_y)
                    elif(black_pawn_flag == 2):
                        black_pawn_3.add_to_board(mess_board_x,mess_board_y)
                    elif(black_pawn_flag == 3):
                        black_pawn_4.add_to_board(mess_board_x,mess_board_y)
                    elif(black_pawn_flag == 4):
                        black_pawn_5.add_to_board(mess_board_x,mess_board_y)
                    black_pawn_flag += 1   
                    mess_board_x += 1 
                # print(mess_chessman)   
